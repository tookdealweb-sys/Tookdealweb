  ...
  return (
    <div className="bg-black py-16">
      <div className="max-w-4xl mx-auto px-6">
        ...
        {/* Mission */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-white-900 mb-6">Our Mission</h2>
          
          <div className="space-y-4 text-lg text-white-700 leading-relaxed">
            <p>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h3 className="text-xl font-bold text-white-900 mb-4">For Shoppers</h3>
            <ul className="space-y-3 text-white-700">
          ...
          <div>
            <h3 className="text-xl font-bold text-white-900 mb-4">For Merchants</h3>
            <ul className="space-y-3 text-white-700">
